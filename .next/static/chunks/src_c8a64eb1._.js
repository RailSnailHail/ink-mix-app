...
"[project]/src/app/mixes/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function MixesPage() {
    ...
    const { mixName, setMixName, components, addComponent, removeLastComponent, clearMix, activeRecipe, targetGrams, setTargetGrams } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMixStore"])();
            ...
            async function fetchInks() {
                ...
                if (response.ok) {
                    ...
                    const groups = data.reduce({
                        "MixesPage.useEffect.fetchInks.groups": (acc, ink)=>{
                            (acc[ink.shade] = acc[ink.shade] || []).push(ink);
                            return acc;
                        }
                    }["MixesPage.useEffect.fetchInks.groups"], {});
    ...
    const handleFinishMix = async ()=>{
        ...
        if (response.ok) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$5_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Recipe "${mixName}" saved successfully!`);
            clearMix();
            setFinishDialogOpen(false);
            router.push('/recipes');
        } else {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$5_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to save mix. Please try again.");
        }
    };
...
_s(MixesPage, "iHqbesb7uQ+CBBDPOtlwhI8fCCw=", false, function() {
    return [
...
_c = MixesPage;
var _c;
__turbopack_context__.k.register(_c, "MixesPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_c8a64eb1._.js.map